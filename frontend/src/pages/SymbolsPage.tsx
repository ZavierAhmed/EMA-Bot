...
import { getMonitoredSymbols, removeMonitoredSymbol, setSymbolEnabled, type MonitoredSymbol } from '../api'
...
export function SymbolsPage() {
  ...
  async function refresh() {
    ...
    try { setMonitored(await getMonitoredSymbols()) }
