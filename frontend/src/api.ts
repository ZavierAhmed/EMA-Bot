...
export const createDemoStrategySession = (interval: string, symbols: string[]) => protectedRequest<DemoStrategySession>('/api/demo-strategy-sessions', 'POST', { interval, symbols })
