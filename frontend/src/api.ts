...
export type PaperSessionSummary = { id: number; interval: string; status: string; startedAtUtc: string; symbolCount: number; completedTrades: number; netPnlUsdt: number; totalFeesUsdt: number; accountCurrency: string; netPnl: number; totalTradingCosts: number }
