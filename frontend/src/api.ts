...
export type MonitoredSymbol = { id: number; source: 'LegacyBinance' | 'Mt5Exness'; sourceLabel: string; symbol: string; displayName: string | null; baseAsset: string | null; quoteAsset: string | null; isEnabled: boolean }
