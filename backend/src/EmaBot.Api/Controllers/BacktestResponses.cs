...
public sealed record BacktestRunSummaryResponse(
    ...
    bool WaitForConfirmationCandle, bool UseEma100Filter, bool UseHtfRegimeFilter, bool TrailingStopEnabled, bool UseAdaptiveInitialStop, bool SameTrendReentryEnabled, int MaxReentryAgeBars, decimal FeePercentPerSide,
...
public static class BacktestResponseMapper
{
    public static BacktestRunSummaryResponse ToSummary(BacktestRun run) => new(
        ...
        run.WaitForConfirmationCandle, run.UseEma100Filter, run.UseHtfRegimeFilter, run.TrailingStopEnabled, run.UseAdaptiveInitialStop, run.SameTrendReentryEnabled, run.MaxReentryAgeBars, run.FeePercentPerSide,
    ...
    public static BacktestRunDetailResponse ToDetail(BacktestRun run)
    {
        ...
        return new(summary.Id, summary.Symbol, summary.MarketDataSource, summary.MarketDataSourceLabel, summary.Interval, summary.RequestedStartUtc, summary.RequestedEndUtc,
            ...
            summary.TrailingStopEnabled, summary.UseAdaptiveInitialStop, summary.SameTrendReentryEnabled, summary.MaxReentryAgeBars, summary.FeePercentPerSide, summary.TotalTrades, summary.WinningTrades,
