...
public sealed record Mt5ExecutionPositionPayload(bool Accepted, bool IsClosed, long? PositionTicket, long? PositionIdentifier, long? MagicNumber, string? BrokerSymbol, string? Side, decimal? VolumeLots, decimal? OpenPrice, string? NativeComment = null, decimal? StopLoss = null, decimal? TakeProfit = null, decimal? Bid = null, decimal? Ask = null, int? Digits = null, decimal? TickSize = null, decimal? PointSize = null, int? StopsLevelPoints = null, int? FreezeLevelPoints = null, decimal? CurrentProfit = null, decimal? CurrentSwap = null, string? AccountCurrency = null);
