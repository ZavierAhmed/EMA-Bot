...
public static class BacktestExcelExport
{
    ...
    private static IEnumerable<object?[]> SummaryRows(BacktestRun run) => Fields(
        ...
        ("NativePositionSizingMode", run.NativePositionSizingMode), ("NativeFixedLots", run.NativeFixedLots), ("NativeMarginPerTradePercent", run.NativeMarginPerTradePercent), ("NativeStartingBalance", run.StartingBalance),
