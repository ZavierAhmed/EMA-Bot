...
public sealed class PomeloQueryRegressionTests
{
    ...
    public void PaperDecisionLedgerMigration_IsDiscoveredForEmaBotDbContext()
    {
        ...
        Assert.Contains("20260817133000_AddDemoExecutionReconciliationEvidence", migrations);
        ...
        Assert.True(Array.IndexOf(migrations, "20260817120000_AddDemoExecutionFoundation") < Array.IndexOf(migrations, "20260817133000_AddDemoExecutionReconciliationEvidence"));
    }
